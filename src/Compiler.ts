...
function peg$parse( input: string, options?: ParseOptions ) {
    ...
    const peg$c3 = function ( a: any ): any {
        return new TextToken( text(), location().start.line, location().start.column )
    };
    const peg$c4 = "{{";
    const peg$c5 = peg$literalExpectation( "{{", false );
    const peg$c6 = "}}";
    const peg$c7 = peg$literalExpectation( "}}", false );
    const peg$c8 = function ( a: any ): any {
        return new LiteralToken( a, text(), location().start.line, location().start.column )
    };
    const peg$c9 = function ( a: any, b: any ): any {
        return new ExpressionToken( a, b, text(), location().start.line, location().start.column )
    };
    const peg$c10 = "@";
    const peg$c11 = peg$literalExpectation( "@", false );
    const peg$c12 = function ( b: any, a: any ): any {
        return new IdentifierToken( a, '@' === b, text(), location().start.line, location().start.column )
    };
    const peg$c13 = ".";
    const peg$c14 = peg$literalExpectation( ".", false );
    const peg$c15 = function ( a: any ): any {
        return new ObjectAccessToken( a, text(), location().start.line, location().start.column )
    };
    const peg$c16 = "[";
    const peg$c17 = peg$literalExpectation( "[", false );
    const peg$c18 = "]";
    const peg$c19 = peg$literalExpectation( "]", false );
    const peg$c20 = function ( a: any ): any {
        return new ArrayAccessToken( a, text(), location().start.line, location().start.column )
    };
    const peg$c21 = /^[ \t\r\n]/;
    ...
    const peg$c38 = function ( a: any ): any {
        return parseInt( [ a[ 0 ], a[ 1 ], ...a[ 2 ] ].join( '' ), 10 )
    };
    const peg$c39 = function ( a: any ): any {
        return parseFloat( [ a[ 0 ], a[ 1 ], a[ 2 ].join( '' ), '.', a[ 4 ].join( '' ) ].join( '' ) )
    };
    const peg$c40 = function ( a: any ): any {
        return parseFloat( [ ...a.slice( 0, 3 ), ...a[ 3 ] ].join( '' ) )
    };
    const peg$c41 = "'";
    ...
    const peg$c47 = function ( a: any ): any {
    ...
    const peg$c54 = function ( a: any ): any {
        return a.map( ( v: any ) => '\\"' === v ? v[ 1 ] : v ).join( '' )
    };
    const peg$c55 = "`";
    ...
    const peg$c63 = function ( a: any ): any {
        return a.map( ( [ , v ]: any ) => "\\`" === v ? v[ 1 ] : v ).join( '' )
    };
    ...
    const peg$c68 = function ( a: any ): any {
        return [ a[ 0 ], ...a[ 1 ] ].join( '' )
    };
