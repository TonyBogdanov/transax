import { VitePluginInputType } from '../../Type/VitePluginInputType';
 ...
 */
export default class VitePluginInput implements VitePluginInputType {
     ...
     * @param options
     */
    constructor( options: VitePluginInputType ) {
