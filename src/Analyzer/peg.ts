...
// @ts-ignore
  ...
  var peg$e0 = peg$classExpectation([["a", "z"], ["A", "Z"], "_", "$"], true, false);
...
// @ts-ignore
 ...
 return a.flat().filter( ( v: any ) => v instanceof AnalyzerToken ) };// @ts-ignore

  var peg$f1 = function(a, b) {// @ts-ignore
 return new AnalyzerToken( a, b, text(), location() ) };// @ts-ignore

  var peg$f2 = function(a) {// @ts-ignore
 return a.map( ( v: any ) => -1 < [ "\\'", "\\\\" ].indexOf( v ) ? v[1] : v ).join( '' ) };// @ts-ignore

  var peg$f3 = function(a) {// @ts-ignore
 return a.map( ( v: any ) => -1 < [ '\\"', "\\\\" ].indexOf( v ) ? v[1] : v ).join( '' ) };// @ts-ignore
